...
var CustomImportScript = (() => {
  ...
  // tools/importer/import-about-grace.js
  var import_about_grace_exports = {};
  __export(import_about_grace_exports, {
    default: () => import_about_grace_default
  });
  ...
  var PAGE_TEMPLATE = {
    name: "about-grace",
    description: "Grace About page: full-bleed hero and a 3-column grid of navigation tiles linking to About subpages.",
    urls: ["https://grace.com/about-grace/"],
    blocks: [
      { name: "hero-fullbleed", instances: ["div.generic-hero:has(h1)", ".generic-hero"] },
      { name: "cards-industry", instances: ['div.card-list:has(a[href*="/about-grace/"])'] }
    ],
    sections: [
      { id: "section-1-hero", name: "Hero", selector: ["div.generic-hero:has(h1)"], style: null, blocks: ["hero-fullbleed"], defaultContent: [] },
      { id: "section-2-tiles", name: "About Grace navigation tile grid", selector: ['div.section:has(.card-list a[href*="/about-grace/"])'], style: null, blocks: ["cards-industry"], defaultContent: [] }
    ]
  };
  var transformers = [
    transform,
  ...
  var import_about_grace_default = {
    transform: (payload) => {
      const {
        document: document2,
        url,
      ...
      main.querySelectorAll('img[alt=""], img:not([alt])').forEach((img) => {
        const src = img.getAttribute("src") || "";
        if (/hero\/(home|products|about)/i.test(src) || /\/(Feature-BG|Feature-BG-light|hero-bg)/i.test(src)) {
  ...
  return __toCommonJS(import_about_grace_exports);
})();
