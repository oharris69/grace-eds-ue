...
var CustomImportScript = (() => {
  ...
  // tools/importer/import-industries.js
  var import_industries_exports = {};
  __export(import_industries_exports, {
    default: () => import_industries_default
  });
  ...
  var parsers = {
    ...
    "cards-industry": parse2,
    "cards-insights": parse3
  };
  var PAGE_TEMPLATE = {
    name: "industries",
    description: "Grace Industries landing page: full-bleed hero, intro statement, 3-column industry tile grid (11 tiles), and latest insights blog row.",
    urls: ["https://grace.com/industries/"],
    blocks: [
    ...
    sections: [
      ...
      { id: "section-2-intro", name: "Intro statement", selector: ["div.section:has(> section .rich-text)"], style: null, blocks: [], defaultContent: ["div.section:has(> section .rich-text) h4", "div.section:has(> section .rich-text) p"] },
      { id: "section-3-tiles", name: "Industries tile grid", selector: ['div.section:has(.card-list a[href*="/industries/"])'], style: "light-gray", blocks: ["cards-industry"], defaultContent: ['div.section:has(.card-list a[href*="/industries/"]) h2'] },
  ...
  var import_industries_default = {
    transform: (payload) => {
      ...
      main.querySelectorAll('img[alt=""], img:not([alt])').forEach((img) => {
        const src = img.getAttribute("src") || "";
        if (/hero\/(home|products|about|industries)/i.test(src) || /\/(Feature-BG|Feature-BG-light|hero-bg)/i.test(src)) {
  ...
  return __toCommonJS(import_industries_exports);
})();
